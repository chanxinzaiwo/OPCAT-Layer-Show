...
import { Cpu, FileCode, Coins, ArrowLeftRight, Play, Lock, Database, Zap, AlertCircle, Braces, Binary, FileJson, Layers, ShieldCheck, Network, CheckCircle2, Pickaxe, Clock, FileKey, RefreshCcw, ArrowDown, ArrowRight, Server, XCircle, ScrollText } from 'lucide-react';
    ...
    <section id="architecture" className="py-24 bg-stone-900 text-white">
        <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-5xl font-black mb-6">OP_CAT Layer：四大核心支柱</h2>
                <p className="text-stone-400 max-w-2xl mx-auto text-lg">
                    这是一个完整的、模块化的比特币原生解决方案。点击下方模块查看深度演示。
                </p>
            </div>

            <div className="grid lg:grid-cols-12 gap-8 h-[750px] lg:h-[600px]">
