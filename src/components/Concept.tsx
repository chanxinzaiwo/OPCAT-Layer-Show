...
import { Merge, Database, Code, Wand2, Cpu, Scan, CheckCircle2, Layers, ArrowDown, ShieldAlert, ShieldCheck, Search, RefreshCw, Link, History, FileCode } from 'lucide-react';
  ...
  return (
    <section id="concept" className="py-24 bg-stone-50 border-t border-stone-200 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="relative bg-stone-900 rounded-3xl p-1 shadow-2xl max-w-4xl mx-auto border border-stone-700 group mb-32">
          ...
          <div className="relative bg-[#0c0c0c] rounded-[22px] p-8 md:p-16 overflow-hidden min-h-[320px] flex flex-col items-center justify-center">
            ...
            {/* THE ANIMATION STAGE */}
            <div className="relative z-10 w-full flex justify-center items-center h-48">
              {/* Left Block (Data A) */}
            ...
            <div className="mt-8 z-10">
                {status === 'completed' ? (
                    <button onClick={reset} className="bg-stone-800 hover:bg-stone-700 text-stone-300 px-6 py-2 rounded-full text-sm font-bold transition-all flex items-center gap-2 border border-stone-600">
                        <Wand2 size={14} /> 重置演示
                    </button>
                ) : (
